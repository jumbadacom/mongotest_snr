...
//	}
	...
	public ResponseEntity<List<Tail>> getByTypeAndUserIdAndIncludeHided(@PathVariable(name="type") Type type, @PathVariable(name="userId") String userId) {
	...
	public ResponseEntity<List<Tail>> getByTagAndRecentlyAndIncludeHided(@PathVariable String userId,@RequestBody List<String> tags) {
