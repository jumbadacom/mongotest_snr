...
import com.jangle.mongotest_snr.mongotest_snr.api.tail.Tail;
import com.jangle.mongotest_snr.mongotest_snr.api.tail.TailRepository;
...
public class MongotestSnrApplication {
	...
	@Bean
	public CommandLineRunner init(UserRepository userRepository, JangleRepository jangleRepository,TailRepository tailRepository) {
